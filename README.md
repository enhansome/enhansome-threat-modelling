# Awesome Threat Modeling with stars
...
* [Threat Modeling Trinity](https://github.com/juliocesarfort/public-pentesting-reports/blob/master/COMSATS_Islamabad-CyberSecurityLab/Threat_Modeling_Trinity_Wallet.pdf) ⭐ 9,680 | 🐛 16 | 🌐 HTML | 📅 2026-06-07
...
* [Kubernetes Threat Model](https://github.com/kubernetes/sig-security/tree/main/sig-security-external-audit/security-audit-2019/findings) ⭐ 249 | 🐛 17 | 🌐 Go | 📅 2026-08-07
...
* [Threat Modeling Online Game](https://github.com/dehydr8/elevation-of-privilege) ⭐ 163 | 🐛 33 | 🌐 JavaScript | 📅 2026-08-02 - Online version of the Elevation of Privilege and Cornucopia card games. The easy way to get started with threat modeling.
...
* [Raindance](https://github.com/devsecops/raindance) ⭐ 48 | 🐛 2 | 🌐 GCC Machine Description | 📅 2016-11-24 - Project intended to make Attack Maps part of software development by reducing the time it takes to complete them.
...
* [PyTM](https://github.com/izar/pytm) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - PyTM is an open source project providing a library for threat modeling with code. Describe your system using OO syntax (object.property = value) and have your threat modeling report automatically generated. 100+ threats currently supported.
